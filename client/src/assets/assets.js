...
import icons8_edit_32 from "./icons8-edit-32.svg"
...
export const cityList = [
  ...
  'Surat', 'Pune', 'Jaipur', 'Kanpur', 'Lucknow', 'Nagpur', 'Indore', 'Patna',
  'Vadodara', 'Ghaziabad', 'Ludhiana', 'Agra', 'Nashik', 'Faridabad', 'Meerut',
  'Rajkot', 'Kalyan-Dombivli', 'Vasai-Virar', 'Varanasi', 'Srinagar', 'Aurangabad',
  'Dhanbad', 'Amritsar', 'Navi Mumbai', 'Allahabad', 'Howrah', 'Ranchi', 'Coimbatore',
  'Jabalpur', 'Gwalior', 'Vijayawada', 'Madurai', 'Chandrapur', 'Bhopal', 'Bhubaneswar',
  'Mysuru', 'Chandigarh', 'Guwahati', 'Solapur', 'Tirunelveli', 'Jammu', 'Dehradun',
  'Siliguri', 'Udaipur', 'Bikaner', 'Kochi', 'Jodhpur', 'Kozhikode', 'Gurugram',
  'Mangalore', 'Belagavi', 'Tiruppur', 'Warangal', 'Nanded', 'Bhilai', 'Durgapur',
  'Kolhapur', 'Rourkela', 'Jammu', 'Bhubaneshwar', 'Bhopal', 'Patiala', 'Bikaner',
  'Gaya', 'Rohtak', 'Haldwani', 'Kochi', 'Rishikesh', 'Haridwar', 'Gaya', 'Dibrugarh'
];
...
export const ownerMenuLinks = [
    ...
    { name: "Newsletter", path: "/owner/newsletter", icon: gmail_logo, coloredIcon: gmail_logo },
    { name: "My Profile", path: "/owner/profile", icon: users_icon, coloredIcon: users_icon },
]
